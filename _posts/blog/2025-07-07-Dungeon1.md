...
1. **Cunegund the [Atral Knight](/monsters/knight)** and 1D8 [Squires](/monsters/bandits)
<details markdown="1">
<summary>Details</summary>
Cunegund is a questing knight from the dream-fortress of St-Nugibert. There are 8 squires in total in the dungeon, including Belfrey. Squires that are not with currently with Cunegund are camping with Rottrad in the Mill (#5).

- <ins>Disposition</ins>: authoritative and high as a kite.
- <ins>Wants</ins>: Establish a base of operation in the Windmill (#5) to close the portal (#6) aind restore planar integrity. Obtain mountain poppy.

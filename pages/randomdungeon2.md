...
<script>
    ...
    for (let i = 0; i < 2; i++) {
        ...
        console.log("→", col, "=", primaryRow[col]);
    ...
    for (let i = 0; i < 2; i++) {
        ...
        console.log("→ Other row", i + 1, ":", col, "=", otherRow?.[col]);
        if (otherRow) {

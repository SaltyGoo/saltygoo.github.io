...
_Elven agility, Mad emotions, Hunger for magic._
...
It **can** see in the dark, sneak very efficiently and smell magic. 
**However**, direct sunlight makes it lose all resistances and immunities, and luminous object ignore their resistances and immunities.

**Also**, if it is hit by a spell, the shadow gains an additional attack per round for the rest of the battle. If it manages to kill a magic-user, the elven shadow will recover its original, beautiful elven form just long enough to cast [one spell](/list/spells) (roll randomly) before being vaporized again into shadow form.

**Attacks (1/round)***

<ins>Shadowy Claws</ins>. The shadow makes a melee attack (1D6). If the target is a magic user, it loses one Spell Dice.

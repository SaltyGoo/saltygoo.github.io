...
Common and less common birds. Tiny or small beasts.

_Birds are feathered winged animals with beaks. These are the stats for a generic bird._
...
It **can** see twice as far as a human being.
...
<ins>Pecks.</ins> To dodge a swarm’s attack, the roll has to beat 10 + the swarm’s HP. It inflicts 1 damage. Hit or miss, the target is [blinded](/2020/11/10/extra-rules/#conditions) until the flock's next turn.
<br>
...
1. Vulture
1. Raven
1. Small Cassowary (flightless but fast runner)

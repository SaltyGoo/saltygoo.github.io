...
Hover and click on the hexes to go to the encounter page for it (does not work on mobile). Each hex has 3 features and can generate encounters from a mix of 6 factions, 6 biomes and their unique fauna and NPCs, and 20 bounty hunters from across the original game. More information here.
